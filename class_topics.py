...
class Topics:
    ...
    def main_menu(self):
        ...
        print("| ================================================== |")
        print("| LINUX ESSENTIALS        |       TRAINING PROGRAM   |")
        print("| ================================================== |")
        print("|____________________________________________________|")
        print("Enter number of topic to train on | (x) to exit")
        print("1)   Module 1 --> Introduction")
        print("2)   Module 2 --> Installation")
        print("3)   Module 3 --> Linux Filesystem")
        print("4)   Module 4 --> Filesystem Management")
        print("5)   Module 5 --> Filesystem Administration")
        print("6)   Module 6 --> Server Deployment")
        print("7)   Module 7 --> Shell")
        print("8)   Module 8 --> System Initialization")
        print("9)   Module 9 --> Linux Processes")
        print("10)  Module 10 --> Administrative Tasks")
        print("11)  Module 11 --> Compression, Backup, Software")
        print("12)  Module 12 --> Network Configuration")
        print("13)  Module 13 --> Network Services & Cloud")
        print("14)  Module 14 --> Security, Troubleshooting, Performance")
